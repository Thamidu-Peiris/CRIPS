    ...
    <div className="font-sans min-h-screen bg-white">
      ...
      <div className="bg-white shadow-sm p-4 mx-4 mt-4 rounded-lg">
        <div className="text-gray-500 text-sm">
          <Link to="/" className="text-green-600 hover:text-green-700 transition">Home</Link> / Terms and Conditions
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto bg-white shadow-lg p-12 mt-10 rounded-xl animate-fade-in">
        ...
        {loading ? (
          ...
          <div className="text-center">
            <h2 className="text-5xl font-extrabold text-[#63A302] mb-6">Terms and Conditions</h2>
