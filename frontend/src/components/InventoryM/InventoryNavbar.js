...
const InventoryNavbar = () => {
  ...
  const updateUserState = () => {
    ...
    if (userInfo) {
      setFirstName(userInfo.firstName || "Inventory Manager");
      ...
      setFirstName("Inventory Manager");
      setLastName("");
  ...
  return (
    <div className="flex justify-between items-center bg-white p-4 shadow-md rounded-2xl">
      <h1 className="text-3xl font-bold text-green-800 font-sans ">🌿 Inventory Manager Dashboard 🌱</h1>
