...
import CSMSidebar from "../../components/CSMSidebar"; // ✅ Sidebar Component
import CSMNavbar from "../../components/CSMNavbar"; // ✅ Navbar Component
      ...
      <div className="flex-1 flex flex-col">
        ...
        <main className="flex-1 p-6">
          <div className="max-w-4xl mx-auto p-6 bg-white shadow-md rounded-lg">
            <h2 className="text-2xl font-bold text-green-700 text-center">Manage Knowledge Base</h2>
